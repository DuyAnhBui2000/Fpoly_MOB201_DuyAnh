package buiduyanh.fpoly.buiduyanh.model;
...
public class KhoaHoc implements Serializable {
    ...
    public KhoaHoc(int id, String courseName, String schedule, String testSchedule, int idCoursePhoto) {
        this.id = id;
    ...
    public KhoaHoc(int id, String courseName, String schedule, String testSchedule, int idCoursePhoto, boolean checkRegistration) {
        this.id = id;
        this.courseName = courseName;
        this.schedule = schedule;
        this.testSchedule = testSchedule;
